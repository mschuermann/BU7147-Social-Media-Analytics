...
compare.stars <- data.table(" "= c("Average 5-Star-Score identified from Sentiments", "Average 5-Star-Score given by users") ,"S22"=c(round(afinn.mean.score_s, digits=1), samsung.review.stars), "iPhone 13" = c(round(afinn.mean.score_a, digits=1), iphone.review.stars))
```
