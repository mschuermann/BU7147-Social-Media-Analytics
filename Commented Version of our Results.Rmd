...
Now we want to extract the sentiment terms for both phones.
...
We need to preprocess data again because we do not want specific data cleaning that we did for the sentiment analysis in our wordcloud, e.g. emojis that were transformed to words like "crying" should not be included.
